...
<?php else: ?>
# <?php echo app('translator')->get('Halo!'); ?>
<?php endif; ?>
<?php endif; ?>
...
<?php else: ?>
<?php echo app('translator')->get('Best Regards'); ?>,<br>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php /**PATH C:\xampp\htdocs\PROJEK-LARAVEL\lara7-store\resources\views/vendor/notifications/email.blade.php ENDPATH**/ ?>