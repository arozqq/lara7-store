...
<?php endif; ?> 
    ...
    <!-- product Section End -->
     ...
     <?php echo $__env->make('product.featured', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
     <!-- Featured Section End -->
 
     <!-- Banner Begin -->
     <?php echo $__env->make('product.bannerBottom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
     <!-- Banner End -->
   ...
   <?php echo $__env->make('layouts.front_layout.front-footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php /**PATH C:\xampp\htdocs\PROJEK-LARAVEL\lara7-store\resources\views/layouts/product/product-master.blade.php ENDPATH**/ ?>