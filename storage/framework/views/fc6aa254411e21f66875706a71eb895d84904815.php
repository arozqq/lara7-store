...
<div class="modal fade" id="category-modal" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-body">
      <form name="categoryForm" action="<?php echo e(route('admin.app.store_category')); ?>" method="POST">
...
<script>
  $(document).ready(function(){
    $('#categories-datatables').DataTable({
      processing:true,
      serverside:true,
      ajax:"<?php echo e(route('admin.app.category')); ?>",
      columns: [
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin_layout.admin-master', ['title' => 'Categories'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PROJEK-LARAVEL\lara7-store\resources\views/admin/category.blade.php ENDPATH**/ ?>