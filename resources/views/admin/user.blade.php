@extends('layouts.admin_layout.admin-master', ['title' => 'User Management'])
@push('before-script')
...
<div class="modal fade" id="crud-modal" aria-hidden="true" >
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-body">
      <form name="userForm" action="{{ route('admin.app.store_user') }}" method="POST">
      ...
      $('#deleteall').on('click', function(e){
        ...
        if(ids.length <= 0)
        {
          alert("Please Selected User Checkbox !")
            ...
            var strIds = ids.join(",");
            $.ajax({
              url:"{{route('admin.deleteSelected')}}",
              type: "POST",
              data:{
                _method:"DELETE",
                _token: '{{csrf_token()}}',
