@extends('layouts.admin_layout.admin-master', ['title' => 'Brands'])
@push('before-script')
        ...
        columns: [
          ...
          {data:'brand_name',name:'brand_name'},
          {
            ...
            render: function(data, type, full, meta){
              if(data === null) {
              return '<img src="{{asset("assets/img/p-50.png")}}" height="50"/>';
              } else {
...
$("#modal-preview").attr('src','https://via.placeholder.com/150');
  ...
  $.get('/brand/'+id+'/edit', function (data) {
      ...
      if(data.logo){
      $('#modal-preview').attr('src','{{asset("storage/")}}/' +data.logo);    
